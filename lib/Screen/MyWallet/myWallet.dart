...
import 'package:provider/Components/card.dart';
...
//IconData icon, String title, String date, String balance
  List<Map<String, dynamic>> listService = [
    ...
    },
    {
      "id": '1',
      "icon": Icons.work,
      "title": "Freelance word",
      "date": "19-05-2019",
      "balance": "Euro+200,000"
    },
    {
      "id": '2',
        ...
        child: ListView(
          children: <Widget>[
            Container(
              ...
              child: BankCard(
                card: BankCardModel(
                    'assets/image/icon/bg_blue_card.png',
                    'Debit Card',
                    'JOHN',
                    '4221 5168 7464 2283',
                    '08/20',
            ...
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, index) {
                  return Container(
                      ...
                      child: historyCard(
                          listService[index]['icon'],
                          listService[index]['title'],
                          listService[index]['date'],
                          listService[index]['balance']));
                }),
          ],
        ),
      ),
