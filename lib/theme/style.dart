...
TextStyle textStylecancel = const TextStyle(
  color: const Color(0XFF000000),
  fontSize: 14.0,
  fontFamily: 'Avenir',
...
TextStyle completeStyle = const TextStyle(
  color: Colors.green,
  fontSize: 14.0,
  fontFamily: 'Avenir',
  fontWeight: FontWeight.bold,
...
TextStyle textGreyBoldcancel = const TextStyle(
  color: Colors.black,
  fontSize: 14.0,
  fontFamily: 'Avenir',
  fontWeight: FontWeight.bold,
...
TextStyle textStyleActive1 = const TextStyle(
  color: const Color.fromRGBO(60, 111, 102, 1),
  fontSize: 14.0,
  fontWeight: FontWeight.normal,
);

TextStyle textStyleActiveBlack = const TextStyle(
  color: Colors.black,
  fontSize: 16.0,
  fontWeight: FontWeight.normal,
);
...
const Color activeColor = const Color(0xFF347CFF);
...
const Color primaryColor = Color.fromRGBO(60, 111, 102, 1);
// const Color primaryColor = const Color(0xFF364167);
...
TextStyle headingBlack3 = new TextStyle(
  color: blackColor,
  fontSize: 15.0,
  fontFamily: 'Avenir',
);
TextStyle headingBlack2 = new TextStyle(
  color: blackColor,
  fontSize: 30.0,
  fontFamily: 'Avenir',
  fontWeight: FontWeight.bold,
);
TextStyle headingBlack1 = new TextStyle(
  color: blackColor,
  fontSize: 15.0,
  fontFamily: 'Avenir',
  fontWeight: FontWeight.bold,
